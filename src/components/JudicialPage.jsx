...
function JudicialPage() {
  ...
  return (
    <div className="bg-gray-100 py-10 min-h-screen">
      <div className="container mx-auto px-4 max-w-4xl mx-auto bg-white shadow-lg rounded p-8 ">
        {/* Heading */}
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-8">
          ...
          <div className="mb-4">
            ...
            <p className="mt-2"><strong>Affidavit:</strong> <a href="#" download className="text-blue-600 hover:underline">View Affidavit.pdf</a></p>
          </div>
